        ...
        request(app)
          ...
          .end(function (err, res) {
            if (err) done(err)
              ...
              expect(res.body).toHaveProperty('UserId', idUserOwner)
        ...
        request(app)
          ...
          .end(function (err, res) {
            if (err) done(err)
              ...
              expect(res.body).toHaveProperty('UserId', idUserMember)
              expect(res.body).toHaveProperty('ProjectId', idProject)
              done()
            }
          })
        ...
        request(app)
          ...
          .end(function (err, res) {
            if (err) done(err)
              ...
              expect(typeof res.body).toEqual('object')
              expect(res.body).toHaveProperty('id', expect.any(Number))
              expect(res.body).toHaveProperty('title', 'Learn React js')
